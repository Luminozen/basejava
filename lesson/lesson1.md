...
- Реализуйте класс `com.topjava.basejava.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.topjava.basejava.webapp.MainArray.main()` и `com.topjava.basejava.webapp.MainTestArrayStorage.main()`
...
6. `com.topjava.basejava.webapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
